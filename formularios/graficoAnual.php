...
require("../Class/verifica.admin.php");
  ...
  $consultChart = "SELECT year(Data) as ano, 
sum( total ) as total 
FROM orders GROUP BY year( Data )";
  ...
  while($row = mysqli_fetch_array($resultado))
  {
    ...
    $chart_data .="{ano:'".$row["ano"]."', total:".$row["total"]."}, ";
...
<div class = "page-wrapper">
    ...
    <div class="col-md-12 col-lg-12">
                    <h2 align="center" style="color:darkblue;">Dados Anuais</h2>
                    <br><br>
                    <div id="chart"></div>
                </div>
</div>
