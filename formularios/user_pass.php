        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Alterar Palavra-passe</h3> </div>
...
<form action="user_pass.php" id="frmClientes" method="POST" enctype="multipart/form-data">

            <label for="nome">Palavra-passe</label>
            <input type="text" readonly="true" class="form-control input-sm" id="Senha" name="Senha">
<br>
                        ...
                        if($total!=0){
                         ...
                         echo
                                "<tr>
                                    ...
                                    <td> ".$result['email']."</td>
                                     <td> 
                              <a href='edit_pass_user.php?codigoU=$result[id_usuarios]&pass=$result[senha]'>
