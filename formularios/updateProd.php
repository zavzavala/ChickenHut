...
<form action="" id="frmClientes" method="post" class="form-submit" enctype="multipart/form-data">
           ...
           <div class="row">
            ...
            <input type="text" activated class="form-control input-md " value="<?php echo $nom;?>" name="nome" id="nome" >
                    </div>
            </div>
            ...
            <div class="form-group">
                   ...
                   <option value="<?php echo $categ;?>" <?php if($categ) echo "selected";?>><?php echo $categ;?></option>
                   <?php echo $options;?>
                    </select>
            </div>
            </div>
 ...
 <div class="col">
         ...
         <label for="id_Codigo_Tempo_espera">Codigo da Categoria</label>
            <input type="text" class="form-control input-md " value="<?php echo $idcateg;?>" name="id_Codigo_Tempo_espera" id="id_categoria" readonly >

</div></div>
 <div class="col">
            <div class="form-group">
            <label for="codigo_espera">Codigo do producto</label>
            <input type="text" class="form-control input-md " value="<?php echo $codCompra;?>" name="codigo_espera" id="codigo_espera" readonly >
</div></div>

</div>
            <label for="">Descricao</label>
            <input type="text" class="form-control input-md " value=" <?php echo $desc;?>" name="descricao">

            <label for="">Preco</label>
            <input type="text" class="form-control input-md" value="<?php echo $prec;?>" name="preco"><br>
                 ...
                 <input class="btn btn-primary" name="update" type="submit" value="Atualizar">
                            ...
                            <input class="btn btn-warning" name="cancelaProd" type="submit" value="Cancelar">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <?php echo
                    "
                    <a href='updateFotoBebida.php?id=$codprod&nome=$nom'>Click para Alterar imagem</a>
                            "
                            ?>
                    </form>
...
if(isset($_POST['update']) ){
    ...
    if($nome == '' || $descricao == '' || $preco == '' || $codigo_espera == '' ||$id_categoria =='' ||$codigo_espera =='' || $categoria == ''){
...
header('location:updateprod.php');
     ...
     $query = "UPDATE productos SET nome = '$nome', descricao = '$descricao', 
    preco = '$preco', id_categoria='$id_categoria', categoria='$categoria',
    codigoCompra='$codigo_espera' WHERE id_productos = '$codprod'";
...
echo "<script>
    ...
    echo "<script>
            ...
            alert('Falha ao tentar atualizar produto.');
        location.href='produto.php';
