...
<form action="" id="frmClientes" class="form-submit" method="POST" enctype="multipart/form-data">
           ...
           <div class="row">
            ...
            <input type="text" activated class="form-control input-md nome" name="nome" value="<?php echo $nom; ?>" id="nome" >
                    </div>
            </div>
            ...
            <div class="form-group">
                    ...
                    <select id="tipo" placeholder="Selecione o tipo..." name="tipo" class="form-control input-md tipo">
                   <option value="" >Selecione</option>
                    <option value="Agua" <?php if($tip='Agua') echo "selected" ?>>Agua</option>
                  <option value="Bebida doce" <?php if($tip='Bebida doce') echo "selected" ?>>Bebida doce</option>
                  <option value="Bebida alcoolica" <?php if($tip='Bebida alcoolica') echo "selected" ?>>Bebida alcoolica</option>
                    </select>
            </div>
            </div>
            </div>
            ...
            <input type="text" class="form-control input-md descricao" name="descricao" value="<?php echo $desc; ?>">

            <label for="">Preco</label>
            <input type="text" class="form-control input-md preco" name="preco" value="<?php echo $prec; ?>"><br>
       
           
                            <p></p>                     
                            
                            <a>
                 <input class="btn btn-primary " name="updateBebida" type="submit" value="Atualizar">
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="Bebidas.php">
                    ...
                    <?php echo
                    "
                    <a href='updateFotoBebida.php?id=$id_bebida&nome=$nom'>Click para Alterar imagem</a>
                            "
                            ?>
...
echo "<script>
        ...
        location.href='updatebebidas.php';
    ...
    preco = '$preco', tipo='$tipo' WHERE id_productos = '$id_bebida'";
