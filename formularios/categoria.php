    ...
    <form action="" class="form-submit" id="frmClientes">
            <label for="nom_prod">Nome</label>
    <input type="text" class="form-control input-md nomeProd" maxlenght="10" id="nom_prod" >

                <label for="">Codigo</label>
    <input type="text" class="form-control input-md codigo" maxlenght="5" id="codigo" >
    <label for="">Tempo de espera</label>
    <input type="text" class="form-control input-md tempo" maxLenght="10" id="tempo" >
                    <p></p>
                    
                    <a>
                    <input class="btn btn-success btnAdd" type="submit" value="Adicionar">
                    </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" >
                ...
                ?>
                            ...
                            echo
                                    "<tr>
                                        ...
                                        <td>".$mostra['codigo_espera']."</td>
                                        <td>".$mostra['nome_prod']."</td>
                                        <td>".$mostra['tempo']."</td>
                                        <td>
                                        <a href='updateCategoria.php?id=$mostra[id_Codigo_Tempo_espera]
                                        &c_espera=$mostra[codigo_espera]&temp=$mostra[tempo]&categ=$mostra[nome_prod]'>
                                            <button type='button' class='btn btn-warning' ><i class='fas fa-pencil-alt'></i></button>
                                            </a>&nbsp; &nbsp;
                                            <a href='delete_categoria.php?codigo=$mostra[id_Codigo_Tempo_espera]' onclick='return checkdelete()'>
