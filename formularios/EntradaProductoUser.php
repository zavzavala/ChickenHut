...
$sql_code = "SELECT * FROM entrada where id_usuarios ='$iduser'";
...
<input type="text" class="form-control input-sm " id="gasto" name="gasto">
 ...
 <form action=" " id="frmClientes" class="form-submit" enctype="multipart/form-data">
            ...
            <input type="text" activated class="form-control input-sm nome" id="nome" >
            ...
            <input type="text" class="form-control input-sm" readonly id="pago" name="pago"><br>
                            ...
                            <a>
                 <input class="btn btn-primary addProd" type="submit" value="Adicionar">
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="#">
        ...
        $(document).ready(function(){
            $(".addProd").click(function(e){
                  ...
                  $.ajax({
                    url: 'action.php',
                    method: 'POST',
                    data: {nome:nome,quantidade:quantidade,descricao:descricao},
