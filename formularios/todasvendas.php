...
<input type="text" class="form-control input-sm" id="gasto" name="gasto">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-desktop"></i><span class="hide-menu">Pagina inicial</span></a>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fab fa-wpforms"></i><span class="hide-menu">Formularios</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="EntradaProductouser.php">Entrada de produto</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
              ...
              $qr = "SELECT * FROM orders where posto='$posto'";

 $dado = $mysqli->query($qr) or die($mysqli->error);
 ...
 ?>
                   ...
                   <table class="table table-stiped table-hover" id="tabela">
                        <thead>
                            <tr>
                                <th>venda</th>
                                <th>produtos</th>                               
                        ...
                        if($total!=0){
                            while($linha = mysqli_fetch_assoc($dado)){
                                ...
                                "   <tr>
                                    ...
                                    <td>".$linha['Data']."</td>
                                    <td>
                                <a href='imprimir.php?id=$linha[id]&posto=$linha[posto]&Pagamento=$linha[pagamento]
                                    &Dinheiro=$linha[dinheiro]&total=$linha[total]&data=$linha[Data]
                                    &trocos=$linha[trocos]'>
                                   <input type='submit' class='btn btn-xs btn-primary' value='Comprovante'></a>
                                    <a href='Relatorio.php?id=$linha[id]>
