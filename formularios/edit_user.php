...
error_reporting();
    ...
    <form id="user" class="main-form needs-validation" method="POST" action="" novalidate>
        <div class="row">
            <div class="col">
                <div class="form-group">
            <label for="nome">primeiro nome</label>
            <input type="text" name="nome" id="nome" value="<?php echo "$nomeG";?>" class="form-control" required>
    ...
    <input type="text" name="apelido" id="apelido" value="<?php echo "$apelidoG";?>" class="form-control" required>
    ...
    <!--Fim da primeira Row -->
        <div class="form-group">
            ...
            <input type="email" name="email" id="email" value="<?php echo "$emailG";?>" class="form-control" required>
    ...
    <select name="posto" id="posto" class="form-control" required>
       ...
       <option value="<?php echo "$postoG";?>" <?php if($postoG) echo "selected";?>><?php echo $postoG;?></option>
                       <?php echo $options;?>
    </select>
    ...
    <select name="sexo" id="sexo" class="form-control" required>
        <option value=""></option>
        <option value="Masculino" <?php if($sexoG="Masculino") echo "selected";?> >Masculino</option>
        <option value="Feminino" <?php if($sexoG="Feminino") echo "selected";?>>Feminino</option>
    </select>
    ...
    <select name="tipo" id="tipo" class="form-control" required>
        <option value=""></option>
        <option value="Usuario" <?php if($tipoG="Usuario") echo "selected";?> >Usuario</option>
        <option value="Admin" <?php if($tipoG="Admin") echo "selected";?> >Admin</option>
    </select>
    <div class="invalid-feedback">Selecione o tipo de usuario.</div>
        </div>

    <a>
    <input type="submit" class="btn btn-outline-success" id="inser" value="Atualizar" name="updateUser">
    </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="usuarios.php">
    ...
    if($_POST['updateUser']){    
           ...
           $nomeGu =  $_POST['nome'];
           $apelidoGu = $_POST['apelido'];
            $senhaGu = md5($_POST['senha']);
            $sexoGu = $_POST['sexo'];
            $emailGu = $_POST['email'];
            $postoGu = $_POST['posto'];
            $tipoGu = $_POST['tipo'];

          if($nomeGu ==''| $apelidoGu =='' | $senhaGu =='' | $sexoGu =='' | $emailGu =='' | $tipoGu == ''){ 
        ...
        $sql_codeUp = "UPDATE usuarios SET id_usuarios = '$id_user', id_posto='$postoGu', nome='$nomeGu', 
        apelido='$apelidoGu', senha='$senhaGu', sexo='$sexoGu', email='$emailGu', 
        tipo='$tipoGu', data_update=NOW() WHERE id_usuarios = '$id_user'; ";

        $executeUp = $mysqli->query($sql_codeUp) or die($mysqli->error);
    ...
    echo "<script>
            ...
            alert('Falha ao tentar atualizar usuario.');
        location.href='usuarios.php';
