...
<body class="fix-header fix-sidebar" id="pag">
 ...
 $pega_usu = "SELECT * FROM usuarios, posto WHERE posto.id_posto=usuarios.id_posto ";

$pegaU = $mysqli->query($pega_usu) or die($mysqli->error);

    $data =mysqli_num_rows($pegaU);
...
<table class="table table-hover" colspan="100" id="id_da_tabela">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                        ...
                        <tbody>
                            ...
                            while($mostra = mysqli_fetch_assoc($pegaU)){
                            echo "
                                <tr>
                                    <td>".$mostra['id_usuarios']."</td>
                                    <td>".$mostra['nome']."</td>
                                    <td>".$mostra['apelido']."</td>
                                    <td>".$mostra['posto']."</td>
                                    <td>".$mostra['email']."</td>
                                    <td>".$mostra['tipo']."</td>
                                    <td><a href='edit_user.php?id=$mostra[id_usuarios]
                                    &nom=$mostra[nome]&apelid=$mostra[apelido]&emai=$mostra[email]&tip=$mostra[tipo]
                                    &sex=$mostra[sexo]&post=$mostra[id_posto]'>
                                        <span class='btn btn-warning'><i class='fa fa-pencil-alt'>
                                        </i></span>
                                        </a>
                                        <a href='user_delete.php?&usuario=$mostra[id_usuarios]' onclick='return checkdelete()'>
