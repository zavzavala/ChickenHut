...
require("../Class/verifica.admin.php");
  ...
  $consultChart = "SELECT time(Data) as hora, 
sum( total ) as total 
FROM orders where YEAR( Data ) = YEAR( current_date ) GROUP BY time( Data )";
  ...
  while($row = mysqli_fetch_array($resultado))
  {
    ...
    $chart_data .="{hora:'".$row["hora"]."', total:".$row["total"]."}, ";
...
<div class = "page-wrapper">
    ...
    <div class="col-md-12 col-lg-12">
                    <h2 align="center" style="color:darkblue;">Hora do Pico</h2>
                    <br><br>
                    <div id="chart"></div>
                </div>
</div>
