...
!function(){"use strict";angular.module("angular.morris",[])}(),function(){"use strict";angular.module("angular.morris").factory("angularMorris",["$injector",function(e){var a={keyToAttr:function(e,a){return e+a.substring(0,1).toUpperCase()+a.substring(1)},populateScopeDefinition:function(e,r,t,o){return angular.forEach(t,function(t){e[a.keyToAttr(r,t)]=t===o?"@":"="}),e},populateOptions:function(e,r,t,o){return angular.forEach(r,function(r){var n=a.keyToAttr(t,r);o.hasOwnProperty(n)&&"undefined"!=typeof o[n]&&(e[r]=o[n])}),e},processFilterOptions:function(a,r){angular.forEach(a,function(a){if("string"==typeof r[a]&&e.has(r[a]+"Filter")){var t=e.get(r[a]+"Filter");r[a]=function(e){return t.call(this,e)}}})}};return a}])}(),function(){angular.module("angular.morris").directive("areaChart",["angularMorris",function(e){var a=["data","xkey","ykeys","labels","lineColors","lineWidth","pointSize","pointFillColors","pointStrokeColors","ymax","ymin","smooth","hideHover","hoverCallback","parseTime","units","postUnits","preUnits","dateFormat","xLabels","xLabelFormat","xLabelAngle","yLabelFormat","goals","goalStrokeWidth","goalLineColors","events","eventStrokeWidth","eventLineColors","continuousLine","axes","grid","gridTextColor","gridTextSize","gridTextFamily","gridTextWeight","fillOpacity","resize","behaveLikeLine"];return{restrict:"A",scope:e.populateScopeDefinition({lineColors:"="},"area",a,"xkey"),link:function(r,t){r.$watchCollection("areaData",function(o,n){if(r.areaData)if("string"==typeof r.areaData&&(r.areaData=JSON.parse(r.areaData)),"string"==typeof r.areaYkeys&&(r.areaYkeys=JSON.parse(r.areaYkeys)),"string"==typeof r.areaLabels&&(r.areaLabels=JSON.parse(r.areaLabels)),"string"==typeof r.lineColors&&(r.lineColors=JSON.parse(r.lineColors)),r.areaInstance)r.areaInstance.setData(r.areaData);else{var i=e.populateOptions({element:t,lineColors:r.lineColors||["#0b62a4","#7a92a3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"]},a,"area",r);e.processFilterOptions(["dateFormat","xLabelFormat","yLabelFormat"],i),r.areaInstance=new Morris.Area(i)}},!0)}}}])}(),function(){angular.module("angular.morris").directive("barChart",["angularMorris",function(e){var a=["data","xkey","ykeys","labels","barColors","stacked","hideHover","hoverCallback","axes","grid","gridTextColor","gridTextSize","gridTextFamily","gridTextWeight","resize","ymax","ymin","goals","goalStrokeWidth","goalLineColors","yLabelAlign","parseTime","postUnits","preUnits","xLabelAngle","yLabelFormat","events","eventStrokeWidth","eventLineColors"];return{restrict:"A",scope:e.populateScopeDefinition({barColors:"=",barX:"@",barY:"="},"bar",a),link:function(r,t){r.$watchCollection("barData",function(o,n){if(r.barData)if("string"==typeof r.barY&&(r.barY=JSON.parse(r.barY)),"string"==typeof r.barLabels&&(r.barLabels=JSON.parse(r.barLabels)),"string"==typeof r.barData&&(r.barData=JSON.parse(r.barData)),"string"==typeof r.barColors&&(r.barColors=JSON.parse(r.barColors)),"string"==typeof r.barStacked&&(r.barStacked=JSON.parse(r.barStacked)),"string"==typeof r.barResize&&(r.barResize=JSON.parse(r.barResize)),r.barInstance)r.barInstance.setData(r.barData);else{var i=e.populateOptions({element:t,barColors:r.barColors||["#0b62a4","#7a92a3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"],stacked:!1,resize:!1,xkey:r.barX,ykeys:r.barY,xLabelMargin:2},a,"bar",r);r.barInstance=new Morris.Bar(i)}},!0)}}}])}(),function(){angular.module("angular.morris").directive("donutChart",["angularMorris",function(e){var a=["data","colors","formatter","resize","backgroundColor","labelColor"];return{restrict:"A",scope:e.populateScopeDefinition({},"donut",a),link:function(r,t){r.$watch("donutData",function(){if(r.donutData)if("string"==typeof r.donutData&&(r.donutData=JSON.parse(r.donutData)),"string"==typeof r.donutColors&&(r.donutColors=JSON.parse(r.donutColors)),r.donutInstance)r.donutInstance.setData(r.donutData);else{var o=e.populateOptions({element:t,colors:["#0b62a4","#7a92a3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"]},a,"donut",r);e.processFilterOptions(["formatter"],o),r.donutInstance=new Morris.Donut(o)}})}}}])}(),function(){angular.module("angular.morris").directive("lineChart",["angularMorris",function(e){var a=["data","xkey","ykeys","labels","lineColors","lineWidth","pointSize","pointFillColors","pointStrokeColors","ymax","ymin","smooth","hideHover","hoverCallback","parseTime","units","postUnits","preUnits","dateFormat","xLabels","xLabelFormat","xLabelAngle","yLabelFormat","goals","goalStrokeWidth","goalLineColors","events","eventStrokeWidth","eventLineColors","continuousLine","axes","grid","gridTextColor","gridTextSize","gridTextFamily","gridTextWeight","fillOpacity","resize"];return{restrict:"A",scope:e.populateScopeDefinition({lineColors:"=",parseTime:"="},"line",a,"xkey"),link:function(r,t){r.$watch("lineData",function(){if(r.lineData)if("string"==typeof r.lineData&&(r.lineData=JSON.parse(r.lineData)),"string"==typeof r.lineLabels&&(r.lineLabels=JSON.parse(r.lineLabels)),"string"==typeof r.lineColors&&(r.lineColors=JSON.parse(r.lineColors)),"boolean"==typeof r.parseTime&&(r.parseTime=JSON.parse(r.parseTime)),r.lineInstance)r.lineInstance.setData(r.lineData);else{var o=e.populateOptions({element:t,lineColors:r.lineColors||["#0b62a4","#7a92a3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"],parseTime:r.parseTime},a,"line",r);e.processFilterOptions(["dateFormat","xLabelFormat","yLabelFormat"],o),r.lineInstance=new Morris.Line(o)}})}}}])}();
